...
def add_mesh( polygons, filename ):
    ...
    for line in lines:
        ...
        if len(vals) > 0 and vals[0] == 'v':
            v.append([float(vals[1]), float(vals[2]), float(vals[3])])
        elif len(vals) > 0 and vals[0] == 'f':
            f = []
            for val in vals:
                f.append(val.split('/')[0])
            if len(vals) == 4:
                p1 = v[int(f[1])-1]
                p2 = v[int(f[2])-1]
                p3 = v[int(f[3])-1]
                ...
                add_polygon( polygons,
                             ...
                             p2[0], p2[1], p2[2],
                             p3[0], p3[1], p3[2] )
            #to deal with quadrilateral faces
            elif len(vals) == 5:
                p1 = v[int(f[1])-1]
                p2 = v[int(f[2])-1]
                p3 = v[int(f[3])-1]
